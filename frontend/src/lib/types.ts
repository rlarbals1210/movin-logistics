 ...
 *
 * 공통 데이터 계약이므로 축을 바꿀 때는 어댑터·백엔드 검증·예측 JSON을
 * 같은 변경에서 함께 맞춘다. 화면 전용 확장 필드는 각 feature 폴더에 둔다.
 */

/** 톤급 — 5 · 11 · 25 세 가지만 쓴다 */
export type 톤급 = 5 | 11 | 25

/** 시간창(분) — 40 · 120 · 240 · 480 · 720 · 1440 여섯 단계 */
export type 시간창분 = 40 | 120 | 240 | 480 | 720 | 1440
